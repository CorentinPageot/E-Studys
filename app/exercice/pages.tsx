        ...
        <div
            ...
            <div style={{ padding: "100px 50px 0 50px" }}>
                ...
                <p style={{ margin: "50px 0" }}>
                    Tu vas avoir une succession de plusieurs animaux et pour
                    chacun d'entre eux, tu devras choisir s'il s'écrit avec la
                    lettre “n” ou la lettre "m". <br />
                    <br /> Par exemple, moi c'est Citron. Mon nom s'écrit alors
                    avec la lettre "n".
                </p>
            </div>
